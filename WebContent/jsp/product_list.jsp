			...
			<div style="overflow: hidden;">
				...
				<ul style="list-style: none;">
					...
					<%
							...
							for(String id:arr){
								%>
					<li style="width: 150px;height: 216;float: left;margin: 0 8px 0 0;padding: 0 18px 15px;text-align: center;"><img src="${pageContext.request.contextPath}/products/1/cs1000<%=id %>.jpg" width="130px" height="130px" /></li>
								<%
							}
						}
						
					%> --%>
					<%-- <c:forEach	items="${cookie.ids }" var="p">
					<li style="width: 150px;height: 216;float: left;margin: 0 8px 0 0;padding: 0 18px 15px;text-align: center;"><img src="${pageContext.request.contextPath}/${p.value}" width="130px" height="130px" /></li>
					</c:forEach> --%>
				</ul>
