...
<form class="form-horizontal" action="${pageContext.request.contextPath }/user?method=login" method="post">
 ...
 <div class="form-group">
   ...
   <div class="form-group">
    ...
    <div class="col-sm-3">
       <img src="${pageContext.request.contextPath}/code" title="看不清除,换一张" onclick="changeImg(this)">
    </div>
   ...
   <div class="form-group">
    <div class="col-sm-offset-2 col-sm-10">
      <div class="checkbox">
        <label>
          <input type="checkbox" name="saveName" value="ok"> 自动登录
        </label>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
        <label>
          <input type="checkbox" name="autoLogin" value="ok"> 记住用户名
        </label>
      </div>
    </div>
  </div>
